            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select form-select-sm form-control" name="minQuali" id="minQuali" required>
                        ...
                        <option value="{{$res->id}}" {{ $vacancy->minQualification == $res->id ? 'selected' : ''
                        }}>{{$res->qualification}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-4">
                    ...
                    <textarea type="text" class="form-control form-control-sm" name="course" id="course"
                        required>{{$vacancy->course}}</textarea>
                </div>
                <div class="col-md-4">
                    ...
                    required>{{$vacancy->criteria}}</textarea>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <textarea type="text" class="form-control form-control-sm" name="remuneration" id="remuneration"
                        required>{{$vacancy->remuneration}}</textarea>
                </div>
