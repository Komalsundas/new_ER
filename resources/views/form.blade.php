...
<<<<<<< HEAD
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-1">
                                ...
                                <input type="text" class="form-control form-control-sm" id="math">
                            </div>
                            <div class="col-md-1">
                            ...
                            {{-- For Class XII --}}
                            <legend class="float-none w-auto p-2"
                                style="font-weight: bold; font-size: 13px; font-family: 'Georgia, serif;">CLASS XII
                            </legend>
                            <div class="form-row align-items-center">
                                <div class="col-5">
                                    <label for="schoolName" class="form-label fw-bold small">School Name</label>
                            ...
                            <div class="row g-1">
                                ...
                                <div class="col-md-3">
                                    <label for="cidAttachment" class="form-label fw-bold small">Marksheet
                                        Certificate</label>
                                    <input type="file" class="form-control form-control-sm" id="cidAttachment">
                                </div>
                            </div><br>
