                        ...
                        <div class="card-body"> --}}
                            ...
                            <div class="row">
                                <div class="col-md-6 px-0">
                                    <label for="institute" class="fw-bold">University or School</label>
                                    <input class="form-control" type="text" name="institute" id="institute" placeholder="Name of institute">
                                </div>
                                <div class="col-md-6 px-2">
                                    <label for="qualification" class="fw-bold">Qualification</label>
                                ...
                                <div class="col-md-6 px-2">
                                    ...
                                    <input class="form-control" type="text" name="course" placeholder="Course" id="course">
                                </div>
                            </div>
                            <legend class="float-none w-auto" style="font-weight: bold; font-size: 16px;">Marks</legend>
                            <div class="row">
                                <div class="col-md-6 px-2">
                                    <label for="qualification" class="fw-bold">Qualification</label>
                                    <input class="form-control" type="text" name="qualification" placeholder="Qualification" id="qualification">
