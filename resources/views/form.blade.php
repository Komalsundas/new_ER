        ...
        <div class="tab-content" id="myTabContent0">
            ...
            <div class="tab-pane fade" id="profile0" role="tabpanel" aria-labelledby="profile-tab0">
                <fieldset class="border p-4" style="width: 103%;">
                    ...
                    <div class="row g-2">
                        <div class="col-md-1">
                            <label for="sunject" class="form-label fw-bold small">Subject</label>
                            <label for="marks" class="form-label fw-bold small">Marks</label>
                        </div>
                        <div class="col-md-1">
                            <label for="english" class="form-label fw-bold small">English</label>
                            <input type="text" class="form-control form-control-sm" id="eng">
                        </div>
                        <div class="col-md-1">
                            <label for="dzomgkha" class="form-label fw-bold small">Dzongkha</label>
                            <input type="text" class="form-control form-control-sm" id="dzo">
                        </div>
                        <div class="col-md-1">
                            <label for="math" class="form-label fw-bold small">Math</label>
                            <input type="text" class="form-control form-control-sm" id="mat">
                        </div>
                        <div class="col-md-1">
                            <label for="physics" class="form-label fw-bold small">Physics</label>
                            <input type="text" class="form-control form-control-sm" id="phy">
                        </div>
                        <div class="col-md-1">
                            <label for="chemistry" class="form-label fw-bold small">Chemistry</label>
                            <input type="text" class="form-control form-control-sm" id="che">
                        </div>
                        <div class="col-md-1">
                            <label for="biology" class="form-label fw-bold small">Biology</label>
                            <input type="text" class="form-control form-control-sm" id="bio">
                        </div>
                        <div class="col-md-1">
                            <label for="economics" class="form-label fw-bold small">Economics</label>
                            <input type="text" class="form-control form-control-sm" id="eco">
                        </div>
                        <div class="col-md-1">
                            <label for="history" class="form-label fw-bold small">History</label>
                            <input type="text" class="form-control form-control-sm" id="his">
                        </div>
                        <div class="col-md-1">
                            <label for="geography" class="form-label fw-bold small">Geography</label>
                        ...
                        <div class="col-md-1">
                            <label for="percent" class="form-label fw-bold small">Percentage</label>
                        ...
                        <div id="scienceForm" style="display: none;">
                            <div class="row g-2">
                                ...
                                <div class="col-md-1">
                                    <label for="dzongkha" class="form-label fw-bold small">Dzongkha</label>
                        ...
                        <div id="commerceForm" style="display: none;">
                            <div class="row g-2">
                                ...
                                <div class="col-md-1">
                                    <label for="commerce" class="form-label fw-bold small">Commerce</label>
                                    <input type="text" class="form-control form-control-sm commersemark" id="comcom">
                                </div>
                                <div class="col-md-1">
                                    <label for="economics" class="form-label fw-bold small">Economic</label>
                                    <input type="text" class="form-control form-control-sm commersemark" id="comeco">
                                </div>
                                <div class="col-md-1">
                                    <label for="accountancy" class="form-label fw-bold small">Accountancy</label>
