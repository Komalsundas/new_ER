                        ...
                        <table class="table table-bordered experienceTable" id="experienceTable" style="width: 100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" name="from[]" placeholder="From">
                                    </td>
                        ...
                        <table class="table table-bordered trainingTable" id="trainingTable" style="width: 100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" name="sdate[]" placeholder="Start Date">
                                    </td>
                                    <td><input class="form-control" type="text" name="edate[]" placeholder="End Date">
                                    <td><input type="file" class="form-control-file" name="certificate[]"></td>
                                    <td>
                                        {{-- <button class="btn btn-primary btn-sm" id="insertRowExp">
                                            <i class="fa fa-plus"></i> <span>Add
                                            </span>
...
<script>
    $(function() {
        $("#addTraining").on("click", function(event) {
            ...
            cols +=
                '<td><input class="form-control rounded-4" type="text" name="sdate[]" placeholder="Start Date"></td>'; // Change "period" to "from_period"
            cols +=
                '<td><input class="form-control rounded-4" type="text" name="edate[]" placeholder="End Date"></td>'; // Add "to_period" field
            cols += '<td><input type="file" class="form-control-file" name="certificate[]"></td>';
            cols +=
